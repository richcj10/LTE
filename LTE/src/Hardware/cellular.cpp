...
void Pushover(const char* Title, const char* Message){
  ...
  int SizeOfArray = sprintf(BODY, "token=**REDACTED-PUSHOVER-TOKEN**&user=**REDACTED-PUSHOVER-USERKEY**&title=%s&message=%s",urlencode(Title).c_str(),urlencode(Message).c_str());
